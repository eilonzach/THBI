function model = a0_MAKE_MODEL(par,selev,ifplot)
% model = a0_MAKE_MODEL(par)
% 
...
vs_mantle = sp.evalAt(zm);
vp_mantle = vs_mantle*vpvs_mantle;
rho_mantle = mantle_vs2rho(vs_mantle,zm );

mantle = struct('Nkn',k_mantle,'VS_kn',kvs_crust,'splines',spbasis);
