    function [model,laymodel] = z0_SYNTH_MODEL_fig2_splines(par,ifplot)
...
kvs_mantle = [4.2 4.4  4.5 4.0 4.1 4.2 4.45]';
zspm = [h_sed+h_crust, 70, 110, 140, 210, par.mod.maxz]';
...
[ cspbasis ] = make_splines( zspc,par, zc);
% MANTLE splines
...
[ mspbasis ] = make_splines( zspm,par, zm);
% OVERALL
