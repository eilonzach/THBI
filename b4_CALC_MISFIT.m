...
if any(strcmp(par.inv.datatypes,'PsRF')) 
    misfit2_ps = zeros(length(trudata.PsRF),1);stfpow_ps_tru=misfit2_ps;
    ...
    stfpow_ps_pre = norm(predata.PsRF.ZRT(:,1)) +...
                    norm(predata.PsRF.ZRT(:,2)) +...
                    norm(predata.PsRF.ZRT(:,3));
...
if any(strcmp(par.inv.datatypes,'SpRF'))
    misfit2_sp = zeros(length(trudata.SpRF),1);stfpow_sp_tru=misfit2_sp;
    ...
    stfpow_sp_pre = norm(predata.SpRF.ZRT(:,1)) +...
                    norm(predata.SpRF.ZRT(:,2)) +...
                    norm(predata.SpRF.ZRT(:,3));
